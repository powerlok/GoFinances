...
const Dashboard: React.FC = () => {
  ...
  useEffect(() => {
    async function loadTransactions(): Promise<void> {
      ...
      data.balance.income = formatValue(Number(data.balance.income));
      data.balance.outcome = formatValue(Number(data.balance.outcome));
      data.balance.total = formatValue(Number(data.balance.total));
